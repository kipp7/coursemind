...
| Vendor lock-in | Dify/RAGFlow/model vendor becomes hard to replace | RAG gateway and model gateway adapter boundaries | Documented |
...
| Weak document parsing | Poor citations or missed course context | Evaluate Dify vs RAGFlow with real course samples | Pending |
